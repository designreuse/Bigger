...
!function ($) {
    ...
    BootstrapTable.prototype.getTotalRows=function()
	{
		var that=this;
	
		$.ajax({
			type : that.options.method,
			url : that.options.url.replace(/(^\/)|(\/$)/g,'')+"/count",
			data : '',
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if (that.options.sidePagination === 'server') {
        	//console.log(that.options.pagination);
    ...
    BootstrapTable.prototype.load = function (data) {
        ...
        if (this.options.sidePagination === 'server') {
           ...
           // data = data[this.options.dataField];
        	//load before formatter data
        	if(that.options.onLoadBefore&&typeof(that.options.onLoadBefore)=="function")
			{
				 data=that.options.onLoadBefore.call(that,data);
			}
